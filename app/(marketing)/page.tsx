...
export default function IndexPage() {
    ...
    className="container py-8 mx-auto md:py-12 lg:py-24 bg-slate-50 space-y-6">
                ...
                <div className="mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="bg-background border p-3 rounded-lg ml-4">
                        <div>
